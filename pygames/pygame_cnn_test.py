# ref:http://blog.topspeedsnail.com/archives/10459
...
class Game(object):
    def __init__(self):
        ...
        pygame.display.set_caption('Simple Game')  # 游戏名
...
def train_neural_network(input_image):
    ...
    gt = tf.placeholder("float", [None])  # 收益
    ...
    with tf.Session() as sess:
        ...
        while True:
            ...
            D.append((input_image_data, argmax_t, reward, input_image_data1)) # 队列存储：（旧状态图、动作、收益、新状态图）
